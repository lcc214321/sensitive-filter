...
/**
 * @author shuaiys
 * @Description:  增加一个敏感词：{@link #put(String)} <br/>
...
//    static {
//        try {
//            URL url = new URL("your internet resources"); //网络资源（一个敏感词的txt文件）
//            InputStream is = url.openStream();
//            BufferedInputStream bis = new BufferedInputStream(is);
//            InputStreamReader isr = new InputStreamReader(bis,"utf-8");
//            BufferedReader br = new BufferedReader(isr);
//            DEFAULT = new SensitiveFilter(br);
//            is.close();
//            bis.close();
//            isr.close();
//            br.close();
...
//    }
    ...
    public static final SensitiveFilter DEFAULT = new SensitiveFilter(
            new BufferedReader(new InputStreamReader(
                    ClassLoader.getSystemResourceAsStream("config/sensi_words.txt")
     ...
     * 加快访问速度。
     */
    static final int DEFAULT_INITIAL_CAPACITY = 262144;
